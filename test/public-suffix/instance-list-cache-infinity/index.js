...
async function instanceListCacheInfinityTests (t = () => {}, parentScope = [], sharedState = {}) {
  const scope = [...parentScope, instanceListCacheInfinityTests.name]
...
module.exports = instanceListCacheInfinityTests
